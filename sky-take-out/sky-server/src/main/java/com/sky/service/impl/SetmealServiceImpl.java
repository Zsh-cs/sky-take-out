...
public class SetmealServiceImpl implements SetmealService {
    ...
    public void saveWithDish(SetmealDTO setmealDTO) {
        ...
        setmealDishService.saveDishesBySetmealId(setmeal.getId(),setmealDTO.getSetmealDishes());
    }
    ...
    public void deleteBatch(List<Long> setmealIds) {
        ...
        for (Long setmealId : setmealIds) {
            ...
            setmealDishService.deleteDishesBySetmealId(setmealId);
        }
    }
    ...
    // 根据id查询套餐及其菜品
    @Override
    public SetmealVO getWithDishesById(Long setmealId) {
    ...
    public void updateWithDishes(SetmealDTO setmealDTO) {
        ...
        setmealDishService.deleteDishesBySetmealId(setmeal.getId());
    ...
    public Long getCountByCategoryId(Long categoryId) {
        ...
        setmealLqw.eq(Setmeal::getCategoryId,categoryId);
        Long count = setmealMapper.selectCount(setmealLqw);
        return count;
    }
